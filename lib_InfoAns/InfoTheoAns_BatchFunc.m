function [InfoAnsRes, NetStat] = InfoTheoAns_BatchFunc(nSpk, popVec, parsMdl, varargin)
...
InfoAnsRes.FisherInfo_sext = cellfun(@(n1,n2) fisherInfo_biasCorrect(n1, n2, parsMdl.dPosi*[-1,1]/2, parsMdl, ...
...
InfoAnsRes.FisherInfo_shuffled = cellfun(@(n1,n2) fisherInfo_biasCorrect(n1, n2, parsMdl.dPosi*[-1,1]/2, parsMdl, ...
    'minRateAns', minRateAns, 'bBootStrap', bBootStrap, 'nBootStrap', nBootStrap), ...
    nSpk(1,:), nSpk(2,:));
if bBootStrap
